...
class TuitionFeeCreateRequest extends GlobalFormRequest
{
	/**
	...
	{
		$this->failedAuthMessage = 'Não tem permissão de criar atleta';
	...
	public function rules(): array
	{
		...
		return [
			'athlete_id' => [
				...
				Rule::unique(TuitionFee::class)->where(function ($query) {
