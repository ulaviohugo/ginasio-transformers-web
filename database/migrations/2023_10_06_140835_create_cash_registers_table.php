...
return new class extends Migration
{
	...
	{
		Schema::create(DBHelper::TB_CASH_REGISTERS, function (Blueprint $table) {
			$table->id();
			$table->double('initial_balance', 16, 3)->nullable();
			$table->double('balance', 16, 3);
	...
	{
		Schema::dropIfExists(DBHelper::TB_CASH_REGISTERS);
	}
};
